...
require_relative '../../app/models/landing_page_dsl'
require_relative '../../app/services/landing_page_compiler'
require_relative '../../app/registries/tool_registry'
require_relative '../../app/services/tool_runner'

class ToolRunnerTest < Minitest::Test
  def setup
