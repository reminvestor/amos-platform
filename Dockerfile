...
# docker build -t agent_marketing .
# docker run -d -p 80:80 -e RAILS_MASTER_KEY=<value from config/master.key> --name agent_marketing agent_marketing
...
RUN apt-get update -qq && \
    apt-get install --no-install-recommends -y curl libjemalloc2 libvips postgresql-client imagemagick ghostscript poppler-utils && \
