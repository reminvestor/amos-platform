...
class Agents::StandardPluginExecutor
  ...
  def build_system_prompt
    ...
    parts << "2. Call: `ask_agent_for_help(request_type: 'subtask', helper_agent_slug: 'web_research_specialist', description: 'Research top 100 VCs with their details')`"
    parts << "3. When they return data → use `generate_csv` to create the export"
    parts << "4. Return the combined result to the user"
    parts << ""
    parts << "**❌ NEVER:**"
