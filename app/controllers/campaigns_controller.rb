class CampaignsController < ApplicationController
  ...
  def index
    ...
    all_campaigns = current_entity.campaigns.order(created_at: :desc)
  ...
  def new
    @campaign = current_entity.campaigns.new(status: "draft", user: current_user)
    @contact_groups = current_entity.contact_groups
    @email_templates = current_entity.email_templates
  end

  def create
    @campaign = current_entity.campaigns.new(campaign_params)
