...
# Tail ECS Container Logs in Real-time

echo "📋 Tailing ECS application logs..."
...
echo "📝 Log Stream: ecs/agent-marketing/$CONTAINER_ID"
echo ""
...
while true; do
    ...
    LOGS=$(aws logs get-log-events \
        ...
        --log-stream-name "ecs/agent-marketing/$CONTAINER_ID" \
